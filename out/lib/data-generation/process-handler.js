...
export default function handleProcess(node, productLimit, root) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!existsSync(root))
                        mkdirSync(root);
                    return [4 /*yield*/, traverseSubcategories(node, productLimit, handleProcess, root)];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 7];
                case 2:
...
//# sourceMappingURL=process-handler.js.map