...
export default function (asin) {
    return __awaiter(this, void 0, void 0, function () {
        var agent, browser, page, response, product;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    console.log("https://amazon.com/dp/".concat(asin));
                    return [4 /*yield*/, page.goto("https://amazon.com/dp/".concat(asin), {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, page.evaluate(function (id) {
                            ...
                            var imageUrl = document.body.querySelector("img#landingImage")
                                ? document.body.querySelector("img#landingImage")
                                    .src
                            ...
                            var reviews = Array.from(document.body.querySelectorAll('div[data-hook="review"]')).map(function (profile) {
                                return {
                                    name: (profile.querySelector("span.a-profile-name")
                                        ...
                                        .replace("Amazon", "")
                                        .replace("amazon", ""),
                                    pictureUrl: profile.querySelector(".a-profile-avatar > img")
                                        .src ||
